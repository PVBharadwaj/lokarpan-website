      ...
      <>
        ...
        <div className="fellowship-page">
          <div className="second-div">
            <div className="sub-div">
              ...
              <p className="fellow-data fellow-space-above">
                By joining Lokarpan Fellows, you become part of a
                community-driven initiative where your insights, experiences,
                and ideas are not just valued but actively sought after. Whether
                you're working in a classroom, collaborating with our teams, or
                engaging directly with communities, your voice matters.
              </p>
            </div>
            <div className="sub-div">
              <img
              ...
              <h3 className="impact-title">
                Our Approach is Community Centric
              </h3>
              <p className="fellow-data">
                We believe that true solutions emerge when we listen closely to
                the voices of the communities we serve. By engaging directly
                with those most affected by social challenges, we gain valuable
                insights into their needs and aspirations. Together, we
                co-create innovative initiatives and programs that have a
                meaningful impact and pave the way for a more equitable society.
                engaging directly with communities, your voice matters.
              </p>
            </div>
          </div>
          ...
          <div className="fourth-div">
            ...
            <p className="fourth-div-data fellow-data">
              ...
              professional development. In this role you will have the
              opportunity to work in teams and help the most vulnerable – across
              a wide range of initiatives – solving some of their most difficult
              problems. You will also work with a diverse range of experts in
              the organisation, from researchers to software and app designers.
            </p>
          </div>
        </div>
        ...
        <div className="new-f-text-cont">
          <h1 className="new-f-text">
            ...
            While you'll contribute your unique talents and insights, you'll
            also have the chance to learn and grow in a diverse and dynamic
